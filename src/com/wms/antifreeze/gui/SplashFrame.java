...
//                Logger.getLogger(AFSplashFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        splashPanel = new java.awt.Panel();
        ...
        splashPanel.setBackground(resourceMap.getColor("splashPanel.background")); // NOI18N
        splashPanel.setName("splashPanel"); // NOI18N
        splashPanel.setLayout(new java.awt.GridLayout(1, 0));

        progressStatus.setName("progressStatus"); // NOI18N
        splashPanel.add(progressStatus);
...
//            Logger.getLogger(AFSplashFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private java.awt.Panel splashPanel;
